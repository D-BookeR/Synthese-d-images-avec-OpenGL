...
public class OpenGLActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (configurationInfo.reqGlEsVersion < 0x030000) {
            ...
            // il faudra faire 4 rendus successifs, 1 par buffer
            Material.setGBufferSize(4);
        } else {
            // il ne faudra pas faire de rendus successifs, un seul suffira (0 pour désactiver)
            Material.setGBufferSize(0);
        }
