...
class Scene extends TurnTableScene
{
    ...
    constructor()
    {
        ...
        this.m_Object = new IrregularPyramid();
    ...
    onKeyDown(code)
    {
        switch (code) {
        case 'T'.charCodeAt(0):
            this.rendererObjet.nextTrianglesMode();
            break;
        case 'Y'.charCodeAt(0):
            this.rendererObjet.nextEdgesMode();
            break;
        case 'U'.charCodeAt(0):
            this.rendererObjet.nextNormalsMode();
            break;
        default:
            // appeler la méthode de la superclasse
