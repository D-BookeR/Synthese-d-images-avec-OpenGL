...
class Scene extends TurnTableScene
{
    ...
    onSurfaceChanged(width, height)
    {
        ...
        // créer le traitement d'image
        if (this.m_Saturation != null) this.m_Saturation.destroy();
        this.m_Saturation = new Saturation(width, height);
    }
    ...
    onDrawFrame()
    {
        ...
        // à ce stade, on a une image dans le FBO, on va extraire ses contours
        this.m_Saturation.process(this.m_FBOimage, Math.cos(Utils.Time)*2.0 + 2.0);
    }
