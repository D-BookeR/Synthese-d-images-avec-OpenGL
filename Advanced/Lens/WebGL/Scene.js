...
class Scene extends TurnTableScene
{
    ...
    constructor()
    {
        ...
        this.m_CameraAngleElevation = 13.0;
        vec3.set(this.m_CameraPivot, 0.1, 0.0, -0.2);
        this.m_CameraDistance = 30;

        // ressources
        this.m_FBOimage = null;
        this.m_Lens = new Lens();
    }
    ...
    onSurfaceChanged(width, height)
    {
        ...
        this.m_Lens.setRatio(width / height);
    }
    ...
    onDrawFrame()
    {
        ...
        this.m_Lens.process(this.m_FBOimage, 0.5+0.5*Math.cos(Utils.Time));
    }
