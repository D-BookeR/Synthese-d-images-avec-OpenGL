...
class Scene extends TrackBallScene
{
    ...
    constructor()
    {
        ...
        let border = [];
        border.push(vec2.fromValues(0.0, -1.0));
        border.push(vec2.fromValues(0.4, -1.0));
        border.push(vec2.fromValues(0.5, -0.9));
        border.push(vec2.fromValues(0.6,  0.0));
        border.push(vec2.fromValues(0.3,  0.5));
        border.push(vec2.fromValues(0.3,  0.9));
        border.push(vec2.fromValues(0.2,  1.0));
        border.push(vec2.fromValues(0.0,  1.0));

        // créer l'objet
        this.m_Object = new Lathe(border, 40);
        ...
        // modes de dessin
        this.m_MeshStructureDraw = new MeshStructureDraw(this.m_Object.getMesh(), this.m_Material, null, null, null, 0.25);
    }
