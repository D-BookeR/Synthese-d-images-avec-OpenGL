...
Scene::Scene() : TrackBallScene(true)
{
    ...
    border.push_back(vec2::fromValues(0.0, -1.0));
    border.push_back(vec2::fromValues(0.4, -1.0));
    border.push_back(vec2::fromValues(0.5, -0.9));
    border.push_back(vec2::fromValues(0.6,  0.0));
    border.push_back(vec2::fromValues(0.3,  0.5));
    border.push_back(vec2::fromValues(0.3,  0.9));
    border.push_back(vec2::fromValues(0.2,  1.0));
    border.push_back(vec2::fromValues(0.0,  1.0));
