...
public class SphereTess
{
     ...
     */
    public SphereTess(int platonic_type, int iterations) throws Exception
    {
        ...
        transformation.subdivideAll(m_Mesh.getTriangleList(), iterations, 0.0f);
     ...
     * @return Mesh
     */
    private Mesh createPlatonicSolid(int platonic_type) throws Exception
    {
