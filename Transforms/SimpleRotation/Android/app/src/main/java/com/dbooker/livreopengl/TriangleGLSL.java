...
public class TriangleGLSL
{
    ...
    public TriangleGLSL() throws Exception
    {
        /// Shader
        ...
        m_ShaderId = Utils.makeShaderProgram(srcVertexShader, srcFragmentShader, "TriangleGLSL");
    ...
    public void onDraw()
    {
        ...
        float alpha = Utils.radians(15.0f * Utils.Time);
