...
class TriangleProg
{
    ...
    constructor()
    {
        ...
        this.m_ShaderId = Utils.makeShaderProgram(srcVertexShader, srcFragmentShader, "TriangleProg");
        ...
        this.m_RotationLoc = gl.getUniformLocation(this.m_ShaderId, "Rotation");
    ...
    onDraw()
    {
        ...
        let Rotation = mat2.fromValues(cosa, -sina, sina, cosa);
        mat2.glUniformMatrix(this.m_RotationLoc, Rotation);
