...
import com.dbooker.livreopengl.material.SoftSpotLight;
...
class Scene extends TurnTableScene
{
    ...
    private SoftSpotLight m_Light1;
    private SoftSpotLight m_Light2;
    ...
    Scene() throws Exception
    {
        ...
        m_Light1 = new SoftSpotLight(20.0f, 14.0f, 0.1f, 512, 16f, 25f, true, false, GL_FRONT);
        //m_Light1 = new SoftSpotLight(20.0f, 14.0f, 0.1f, 512, 16f, 25f, false, false, GL_FRONT);
        ...
        // pour PCSS : mettre true, false, gl.FRONT
        // pour PCF : mettre false, true, gl.BACK
        m_Light2 = new SoftSpotLight(20.0f, 14.0f, 0.1f, 512, 4f, 60f, true, false, GL_FRONT);
        //m_Light2 = new SoftSpotLight(20.0f, 14.0f, 0.1f, 512, 4f, 60f, false, false, GL_FRONT);
