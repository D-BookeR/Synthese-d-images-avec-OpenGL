...
class Scene extends TurnTableScene
{
    ...
    constructor()
    {
        ...
        this.m_Light1 = new SpotLightDebug(20.0, 15.0, 512, 16, 25, true, gl.BACK);
        ...
        // définir une lampe spot qui projette de l'ombre
        this.m_Light2 = new SpotLightDebug(20.0, 15.0, 512, 25, 45, true, gl.BACK);
        this.m_Light2.setPosition(vec4.fromValues(8, 3, 0, 1));
    ...
    onDrawFrame()
    {
        ...
        //this.m_Light1.onDrawShadowMap();/*
        //this.m_Light2.onDrawShadowMap();/*
        ...
        // dessiner les lampes
        //this.m_Light1.onDraw(this.m_Mat4Projection, mat4ViewCamera);
        //this.m_Light2.onDraw(this.m_Mat4Projection, mat4ViewCamera);
