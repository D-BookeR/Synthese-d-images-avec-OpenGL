...
class BlinnMaterial extends Material
{
    /**
     ...
     */
    constructor(lights_count, ambiant, diffuse, specular, shininess)
    {
        super("BlinnMaterial");
        ...
        let srcFragmentShader = dedent
            ...
            void main()
            {
                ...
                for (int i=0; i<${lights_count}; i++) {
                    ...
                    // cosinus de l'angle entre N et H
                    float dotNH = clamp(dot(N,H), 0.0, 1.0);

                    // cumul des contributions lumineuses
                    sum += LightsColors[i] * ( Kd*Ka + Kd*dotNL + Ks*pow(dotNH, ns) );
                }
