// Définition de la classe SpecularMaterial
...
class SpecularMaterial extends Material
{
     ...
     */
    constructor(lights_count, specular, shininess)
    {
        super("SpecularMaterial");

        // caractéristiques du matériau
        this.m_SpecularColor = specular;
        this.m_Shininess = shininess * 2.0;
        ...
        let srcFragmentShader = dedent
            ...
            void main()
            {
                ...
                for (int i=0; i<${lights_count}; i++) {
                    ...
                    // vecteur milieu entre V et L
                    vec3 H = normalize(L + V);

                    // cosinus de l'angle entre H et N
                    float dotHN = clamp(dot(H,N), 0.0, 1.0);

                    // cumul des contributions lumineuses
                    sum += LightsColors[i] * ( Ks*pow(dotHN, ns) );
                }
