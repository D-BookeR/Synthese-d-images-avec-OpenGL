 ...
 */
BlinnMaterial::BlinnMaterial(int lights_count, vec3 ambiant, Texture2D* diffuse, vec3 specular, float shininess) :
 ...
 */
void BlinnMaterial::setLightPositionColor(int num, vec4 position, vec3 color)
{
 ...
 */
std::string BlinnMaterial::getVertexShader()
{
 ...
 */
std::string BlinnMaterial::getFragmentShader()
{
    ...
    srcFragmentShader << "\n";
    srcFragmentShader << "        // cosinus de l'angle entre N et H\n";
    srcFragmentShader << "        float dotNH = clamp(dot(N,H), 0.0, 1.0);\n";
    srcFragmentShader << "\n";
    srcFragmentShader << "        // cumul des contributions lumineuses\n";
    srcFragmentShader << "        sum += LightsColors[i] * ( Kd*Ka + Kd*dotNL + Ks*pow(dotNH, ns) );\n";
    srcFragmentShader << "    }\n";
    srcFragmentShader << "\n";
 ...
 */
void BlinnMaterial::compileShader()
{
 ...
 */
VBOset* BlinnMaterial::createVBOset()
{
 ...
 */
void BlinnMaterial::enable(mat4 mat4Projection, mat4 mat4ModelView)
{
    // appeler la méthode de la superclasse
