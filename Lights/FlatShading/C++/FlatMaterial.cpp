 ...
 */
FlatMaterial::FlatMaterial(int lights_count, vec3 diffuse, vec3 specular, float shininess) :
 ...
 */
void FlatMaterial::setLightPositionColor(int num, vec4 position, vec3 color)
{
 ...
 */
std::string FlatMaterial::getVertexShader()
{
    ...
    srcVertexShader << "flat out vec3 frgColor;\n";
    srcVertexShader << "\n";
    ...
    srcVertexShader << "    vec4 pospoint = mat4ModelView * vec4(glVertex, 1.0);\n";
    srcVertexShader << "    gl_Position = mat4Projection * pospoint;\n";
    srcVertexShader << "\n";
    ...
    srcVertexShader << "    vec3 mV = normalize(pospoint.xyz);\n";
    srcVertexShader << "\n";
    ...
    srcVertexShader << "        vec3 L = normalize(LightsPositions[i].xyz - pospoint.xyz);\n";
    srcVertexShader << "\n";
 ...
 */
std::string FlatMaterial::getFragmentShader()
{
 ...
 */
void FlatMaterial::compileShader()
{
 ...
 */
VBOset* FlatMaterial::createVBOset()
{
 ...
 */
void FlatMaterial::enable(mat4 mat4Projection, mat4 mat4ModelView)
{
    // appeler la méthode de la superclasse
