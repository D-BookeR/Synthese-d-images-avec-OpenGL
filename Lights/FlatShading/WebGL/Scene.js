...
class Scene extends TurnTableScene
{
    ...
    constructor()
    {
        ...
        this.m_FlatMaterial  = new FlatMaterial(lights_count, vec3.fromValues(0.1,0.7,0.2), vec3.fromValues(0.8,0.8,0.8), 32);
        ...
        this.m_AppleFlat    = new MeshObjectFromObj("data/models/Apple", "apple.obj", this.m_FlatMaterial, 0.01);
    ...
    onDraw(mat4Projection, mat4ModelView)
    {
        ...
        for (let i=0; i<lights_count; i++) {
            ...
            this.m_FlatMaterial.setLightPositionColor(i, position, this.m_LightsColors[i]);
        }
        ...
        mat4.rotateY(mat4ModelViewApple, mat4ModelViewApple, Utils.radians(Utils.Time * 15.0));
        this.m_AppleFlat.onDraw(mat4Projection, mat4ModelViewApple);
    }
