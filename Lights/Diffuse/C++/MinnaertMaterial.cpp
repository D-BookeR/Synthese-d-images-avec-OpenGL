 ...
 */
MinnaertMaterial::MinnaertMaterial(int lights_count, vec3 diffuse, float m) :
    Material("MinnaertMaterial")
{
 ...
 */
void MinnaertMaterial::setLightPositionColor(int num, vec4 position, vec3 color)
{
 ...
 */
std::string MinnaertMaterial::getVertexShader()
{
 ...
 */
std::string MinnaertMaterial::getFragmentShader()
{
    ...
    srcFragmentShader << "        sum += LightsColors[i] * ( Kd * pow(dotNL*dotNV, m) );\n";
    srcFragmentShader << "    }\n";
    srcFragmentShader << "\n";
 ...
 */
void MinnaertMaterial::compileShader()
{
 ...
 */
VBOset* MinnaertMaterial::createVBOset()
{
 ...
 */
void MinnaertMaterial::enable(mat4 mat4Projection, mat4 mat4ModelView)
{
    // appeler la méthode de la superclasse
 ...
 */
MinnaertMaterial::~MinnaertMaterial()
{
}
