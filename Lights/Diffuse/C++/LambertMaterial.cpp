 ...
 */
LambertMaterial::LambertMaterial(int lights_count, vec3 diffuse) :
 ...
 */
void LambertMaterial::setLightPositionColor(int num, vec4 position, vec3 color)
{
 ...
 */
std::string LambertMaterial::getVertexShader()
{
 ...
 */
std::string LambertMaterial::getFragmentShader()
{
 ...
 */
VBOset* LambertMaterial::createVBOset()
{
 ...
 */
void LambertMaterial::enable(mat4 mat4Projection, mat4 mat4ModelView)
{
    // appeler la méthode de la superclasse
