// Définition de la classe OrenNayarMaterial
...
class OrenNayarMaterial extends Material
{
     ...
     */
    constructor(lights_count, diffuse, sigma)
    {
        super("OrenNayarMaterial");

        // caractéristiques du matériau
        this.m_DiffuseColor = diffuse;
        this.m_Sigma2 = sigma * sigma;
    ...
    getFragmentShader()
    {
        ...
        let srcFragmentShader = dedent
            ...
            const float sigma2 = ${this.m_Sigma2.toFixed(2)};
            ...
            void main()
            {
                ...
                // projection de V dans le plan (T,B) de Frenet
                ...
                for (int i=0; i<${lights_count}; i++) {
                    ...
                    // produit scalaire entre L et N = cosinus de l'angle entre L et N
                    float dotNL = dot(N, L);
                    ...
                    // projection de L dans le plan (T,B) de Frenet
                    vec3 Ltb = normalize(L - N*dotNL);

                    // cosinus de l'angle entre les azimuts de V et L
                    float gamma = max(0.0, dot(Vtb, Ltb));

                    // cumul des contributions lumineuses
                    sum += LightsColors[i] * ( Kd * clamp(dotNL,0.0,1.0) * (a + b*gamma*c) );
                }
