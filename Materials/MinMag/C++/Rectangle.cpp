...
Rectangle::Rectangle()
{
    ...
    // charger la texture
    //m_Texture = new Texture2D("data/textures/grille.png", GL_NEAREST);
    m_Texture = new Texture2D("data/textures/grille.png", GL_LINEAR);
