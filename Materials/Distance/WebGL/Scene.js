...
class Scene extends TurnTableScene
{
    ...
    constructor()
    {
        ...
        this.m_CameraAngleAzimut = 22.0;
        this.m_CameraAngleElevation = 26.0;
        vec3.set(this.m_CameraPivot, 0.0, -0.25, 0.0);
        this.m_CameraDistance = 7.5;
    }
    ...
    onDraw(mat4Projection, mat4ModelView)
    {
        ...
        // dessiner le terrain aplati
        mat4.scale(mat4ModelViewTmp, mat4ModelView, vec3.fromValues(1.0, 0.4, 1.0));
        this.m_Ground.onDraw(mat4Projection, mat4ModelViewTmp);

        // mettre la pomme au dessus
        mat4.translate(mat4ModelViewTmp, mat4ModelView, vec3.fromValues(0.0, 0.1, 0.2));
        this.m_Apple.onDraw(mat4Projection, mat4ModelViewTmp);
    }
