...
Scene::Scene() : TurnTableScene(false)
{
    ...
    m_CameraAngleAzimut = 22.0;
    m_CameraAngleElevation = 26.0;
    vec3::set(m_CameraPivot, 0.0, -0.25, 0.0);
    m_CameraDistance = 7.5;
}
