...
class SpotLightDebug extends SpotLight
{
    /**
     * constructeur
     ...
     */
    constructor(maxangle, minangle, shadowmapsize, near, far, offsetfill=false, cullface=gl.NONE)
    {
        super(maxangle, minangle, shadowmapsize, near, far, offsetfill, cullface);
        this.m_Name = "SpotLightDebug";
        ...
        this.m_DebugShaderId = Utils.makeShaderProgram(srcVertexShader, srcFragmentShader, "SpotLightDebug");
        ...
        for (let i=0; i<nbs; i++) {
            ...
            let b = Utils.radians(360 * (i+1.0) / nbs);
            let cosb = Math.cos(b);
            let sinb = Math.sin(b);
