...
public class SpotLightDebug extends SpotLight
{
     ...
     * @throws Exception
     */
    public SpotLightDebug(float maxangle, float minangle, int shadowmapsize, float near, float far, boolean offsetfill, int cullface) throws Exception
    {
        super(maxangle, minangle, shadowmapsize, near, far, offsetfill, cullface);
        init();
    }
    public SpotLightDebug(float maxangle, float minangle, int shadowmapsize, float near, float far) throws Exception
    {
        super(maxangle, minangle, shadowmapsize, near, far, true, GL_BACK);
        init();
    }
    public SpotLightDebug(float maxangle, float minangle) throws Exception
    {
        super(maxangle, minangle, 0, 1.0f, 100.0f, true, GL_BACK);
        init();
    }
